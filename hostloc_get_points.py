...
def randomly_gen_uspace_url():
    ...
    for i in range(12):
        ...
        url = "https://www.flexsimasia.com/space-uid-{}.html".format(str(uid))
        url_list.append(url)
    return url_list
...
def login(username, password):
    ...
    login_url = "https://www.flexsimasia.com/member.php?mod=logging&action=login&loginsubmit=yes&infloat=yes&lssubmit=yes&inajax=1"
    login_data = {
...
def check_login_status(s, number_c):
    test_url = "https://www.flexsimasia.com/home.php?mod=spacecp"
    res = s.get(test_url)
    res.encoding = "utf-8"
...
if __name__ == "__main__":
    username = os.environ["FLEXSIMASIA_USERNAME"]
    password = os.environ["FLEXSIMASIA_PASSWORD"]
